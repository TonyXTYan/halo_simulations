...
Vpi1 = 0.08*VR # ratio corrent when using intensity=1
tpi1 = 49.8e-3 # ms 
epi1 = 0.9950  # expected efficiency from scan
Vpi2 = 0.04*VR
tpi2 = 49.9e-3
epi2 = (0.4994, 0.499)
```
...
```python
l.info(f"""(Vpi1, tpi1, epi1) = {(Vpi1, tpi1, epi1)}
(Vpi2, tpi2, epi2) = {(Vpi2, tpi2, epi2)}""")
```
